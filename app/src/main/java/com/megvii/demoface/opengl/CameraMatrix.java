...
//	public ArrayList<ArrayList> points = new ArrayList<ArrayList>();
	...
	public CameraMatrix(int textureID) {
		...
		// initialize vertex byte buffer for shape_debug_bg coordinates(初始化顶点字节缓冲区形状坐标)
		...
		// initialize textureVertices byte buffer for shape_debug_bg
	...
	public void draw(float[] mtx) {
		...
		// Prepare the <insert shape_debug_bg here> coordinate data (准备<插入形状这里>坐标数据)
