...
public class StatusBarUtil {
    ...
    public static void setStatusBarForBlueBg(Activity activity, RelativeLayout titleBar){
        setStatusBarFullTransparent(activity);
        setDarkMode(activity);

        if (titleBar != null) {
            setTitleBar(activity, titleBar);
        }
    }

    public static void setStatusBarForGrayBg(Activity activity){
        setFitSystemWindow(activity, true);
        setColor(activity,Color.WHITE,0);
//        setColor(activity, activity.getResources().getColor(R.color.title_bar_bg_color), 0);
        setLightMode(activity);
    }

    private static void setTitleBar(Activity activity, RelativeLayout titleBar){
        int barHeight = StatusBarUtil.getStatusBarHeight(activity);
    ...
    public static void setFitSystemWindow(Context context, boolean fitSystemWindow) {
        View contentViewGroup = ((ViewGroup) ((Activity)context).findViewById(android.R.id.content)).getChildAt(0);
